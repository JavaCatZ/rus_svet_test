 ...
 * @author Bogdan Ch
 * @version 0.0.1
 * @apiNote ДТО-объект запроса на изменение продукта
 * @since 23/03/2024
 */

@Schema(description = "ДТО-объект запроса на изменение продукта")
@JsonNaming(PropertyNamingStrategies.SnakeCaseStrategy.class)
public record ProductUpdReqDto(@Schema(description = "Идентификатор продукта") @Min(1) @NotNull Long id,
